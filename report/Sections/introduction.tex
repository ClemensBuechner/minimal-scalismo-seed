...
We call the result of this learning process a \emph{statistical shape model}. \todoQuestion{Introduce abbreviation SSM here? Or rather in Section~\ref{subsec:ssm}?}
