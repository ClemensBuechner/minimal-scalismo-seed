...
Interestingly, while the average distances increase considerably in comparison to the average distances of the fit to the training data, the Hausdorff distance only increases by half when going from the training data to the reconstruction. This shows that the biggest outliers for the predicted shapes are not much farther away from the correct fit than they were for the fitting of the training data.
