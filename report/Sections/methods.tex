...
These points are in turn used to compute the posterior \todoQuestion{right?} shape.
In our implementation, we stop as soon as the change of the deformation in two consecutive iterations has fallen below a given threshold\todoQuestion{Do we still want to implement this?} or a fixed number of iterations has been reached.
...
The evaluation from the SICAS repository \todoCitation{} is provided in Section \todoMissing{reference}.
