...
%% title information
%% --------------------------------------------
\title{Model-based segmentation of CT images using \\ Markov Chain Monte Carlo Methods and Active Shape Models  \\ \large{Project Report}}
\author{
...
\input{./Sections2/methods}
\input{./Sections2/results}
